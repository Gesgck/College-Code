...
;  Section: 1003
;  Assignment: 1
;  Description: Simple assembly register math
;
...
mov al, byte[bVar1]
add al, byte[bVar2]
mov byte[bAns1], al			; bVar1+bVar2

mov al, byte[bVar1]
sub al, byte[bVar2]
mov byte[bAns2], al			; bVar1-bVar2

mov ax, word[wVar1]
add ax, word[wVar2]
mov word[wAns1], ax			; wVar1+wVar2

mov ax, word[wVar1]
sub ax, word[wVar2]
mov word[wAns2], ax			; wVar1-wVar2

mov eax, dword[dVar1]
add eax, dword[dVar2]
mov dword[dAns1], eax		; dVar1+dVar2

mov eax, dword[dVar1]
sub eax, dword[dVar2]
mov dword[dAns2], eax		; dVar1-dVar2
